...
class PatchBootSystemState(OSEncryptionState):
    ...
    def _modify_pivoted_oldroot(self):
        ...
        if root_partition_uuid:
            ...
            entry = 'osencrypt /dev/disk/by-partuuid/{0} /var/lib/azure_disk_encryption_config/LinuxPassPhraseFileName luks,discard,header=/boot/luks/osluksheader'.format(root_partition_uuid)
